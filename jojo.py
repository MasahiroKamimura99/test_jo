...
def main():
    ...
    {'word':'「根を掘る」ってのはわかる。根っこは土の中に埋まっとるからな。¥nだが「葉掘り」って部分はどういうことだあぁぁ〜！？¥n葉っぱが掘れるかっつーのよ〜ッ！？','attention':'細かいことを気にしすぎです。広い心を持ちましょう。', 'class':'凶', 'pict':'image/giacho.JPG'},
    {'word':'わかったよ。プロシュート兄ィ！！¥兄貴の覚悟が！¥n「言葉」ではなく「心」で理解できた！','attention':'今まで分からなかったことがわかるようになるはずです。', 'class':'大吉', 'pict':'image/pesshi.jpg'},
    {'word':'落ち着け、落ち着くんだ・・・「素数」を数えて落ち着くんだ・・¥n２・・・３、５、７、１１・・・','attention':'素数を数えて、落ち着きましょう。', 'class':'吉', 'pict':'image/puchi.JPG'},
